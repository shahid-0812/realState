        ...
        <nav className="bg-white shadow-lg sticky top-0 z-50 px-4 py-[2rem] ">
            ...
            <div className="hidden lg:flex justify-between items-center px-10">
                    ...
                    <div className="relative">
                        ...
                        {showDropdown && (
                            <div className="absolute left-0 mt-2 bg-white shadow-md rounded-md z-10 flex flex-col gap-4 py-4">
                                <Link to="/about" className="hover:bg-gray-100 py-2 px-8" onClick={() => setShowDropdown(false)}>About</Link>
                                <Link to="/blog" className="hover:bg-gray-100 py-2 px-8" onClick={() => setShowDropdown(false)}>Blog</Link>
                                <Link to="/agents" className="hover:bg-gray-100 py-2 px-8" onClick={() => setShowDropdown(false)}>Agent</Link>
                            </div>
                        )}
                    </div>
                ...
                <div className="flex gap-4 items-center">
                    ...
                    <Link className="bg-[#FFF48E] font-bold px-6 py-2 rounded-full">Explore Now</Link>
                </div>
            </div>
        </nav>
    );
