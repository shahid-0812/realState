...
export const Blog = () => {
    ...
    return (
        <>
            <div className='blog-container px-30 py-15 flex flex-col items-center gap-20 max-md:px-10   '>
                ...
                <div className="blog-section-1 flex flex-col gap-8 border-b border-gray-300 pb-10 ">
                    <div className='flex justify-between items-center'>
                        <span className='text-4xl font-medium capitalize w-[40%]'>Today’s Top stories in best realState</span>
                        <span className='w-[40%] self-end'>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s,</span>
                    </div>
                    <div className='section-1-news flex gap-4 items-stretch'>
                        {/* Left Large Card */}
                        ...
                        {/* Right Small Card */}
                        <div className='w-[300px] relative rounded-xl overflow-hidden flex flex-col gap-4'>
                            <img src="/images/blog/blog-1-2.jpg" className='h-[354px] w-full object-cover rounded-xl' alt="" />
                ...
                <div className="blog-section-2 flex flex-col gap-10">
                    ...
                    <div className="articles w-full flex justify-center items-start gap-6 flex-wrap">
                        ...
                        <div className="article flex flex-col gap-3 w-[48%]">
