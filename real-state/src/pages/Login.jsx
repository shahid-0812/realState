...
export const Login = () => {
  ...
  return (
    <div className='login-container flex px-10 py-5 w-full items-center'>
      <div className="login-left w-1/2 bg-rd-400 flex flex-col h-full gap-20 px-15 mb-10 max-md:w-full max-sm:px-5  ">
        <div className="login-header flex justify-between items-center max-sm:flex-col max-sm:text-center">
        ...
        <div className="login-form flex flex-col gap-6 px-4">
          ...
          <form action="#" className='flex flex-col gap-5 text-gray-700'>
            ...
            <button onClick={() =>navigate("/")} type="submit" className='w-full bg-[#103D47] text-[#fff] font-medium text-xl rounded-full py-3.5 cursor-pointer hover:bg-[#376069] transition duration-300'>Login</button>
          </form>
          ...
          <div className='w-full bg-[#fff] cursor-pointer hover:bg-[#f5f5f5] transition duration-300 border border-gray-300 font-medium rounded-xl flex items-center justify-center gap-4 py-3.5 '>
