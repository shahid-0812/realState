...
export const Home = () => {
    ...
    return (
        <div className='home-container max-md:overflow-hidden'>
            <div className="hero-section flex items-center justify-center py-10">
                <div className='hero-header flex gap-8 items-center justify-between text-[#fff] mx-10'>
                    <div className="hero-text flex flex-col z-10 leading-none ml-20 w-[50%] gap-2">
                        ...
                        <div className="main-text flex flex-col font-bold text-[5.5rem]">
                            ...
                            <div className='flex items-center justify-center'>
                                ...
                                <div className="circle-text transform -translate-x-10 max-md:-translate-x-0 bg-white/50 relative w-[80px] h-[80px] rounded-full flex items-center justify-center mx-auto">
            ...
            {/* <div className="section-1 px-30 max-md:px-10 flex flex-col gap-20">
                <div className="section-1-text flex flex-col justify-between">
                    <div className='flex justify-between items-start w-full'>
                        ...
                        <div className="hero-form bg-red00 self-end mb-4 gap-4 flex flex-col z-10 w-full mr-5 lg:hidden  max-md:w-[50%]">
                            <div className="cur-time flex gap-2 py-2  px-3 items-center justify-center bg-[#fff] rounded-4xl">
                                <span className='px-3 py-2 bg-[#45656E] rounded-4xl'>
                                    <i class="bi bi-globe-americas text-[#FFF48E] text-xl"></i>
                                </span>
            ...
            {/* <div className="section-2 relative px-30 py-15 my-20 bg-[#14161A] text-[#fff] flex flex-col gap-10 items-center max-md:px-10">
                <span className='absolute text-[#fff] text-[14rem] opacity-30 top-18   max-md:hidden  font-bold italic text-center'>REALSTATE</span>
            ...
            {/* <div className="section-3 my-20  px-30  flex flex-col gap-10 max-md:px-10">
                <div className="section-3-header flex justify-between">
                    <div className='flex flex-col gap-6 w-[15%] max-md:w-[30%]'>
                        <span className='font-medium text-3xl'>Check our top agents</span>
                        <span className='px-5 py-3 w-fit rounded-4xl border-1 border-gray-700 text-gray-700 text-center font-medium' >Top Agents</span>
                    </div>
                ...
                <div className="agents flex justify-center items-center gap-5">
                    ...
                    {agentData.map((agent, index) => (
                        <div
                            key={index}
                            className={`
                            agent-card b-red-400 w-[30%] px-5 py-5 rounded-2xl border border-gray-300 flex flex-col gap-5
