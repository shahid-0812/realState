...
export const About = () => {
    ...
    return (
        <>
            <div className='about-container w-full min-h-screen pt-[80px] flex flex-col items-center gap-20 px-15    py-10'>
                <div className="about-header w-[45%] text-center flex flex-col gap-6">
            ...
            <div className="data w-full bg-gray-300 flex justify-evenly items-center gap-10 mt-10 py-10">
            ...
            <div className="founder px-30 py-20 flex justify-between items-center gap-10">
                <div className='flex flex-col gap-8'>
                    ...
                    <div className='flex flex-col w-[80%] font-medium'>
                        <div className='flex items-start'>
                            <i class="bi bi-quote text-5xl tracking-tighter leading-none"></i>
                ...
                <img src="/images/about/founder.jpg" alt="" className='h-[450px]'/>
            </div>
            <News />
            <Testimony />
        </>
